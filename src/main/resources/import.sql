...
INSERT INTO `role` (`ID`, `USER`) VALUES (2, 'ROLE_USER');

INSERT INTO `user` (`ID`, `ENABLED`, `PASSWORD`, `USERNAME`) VALUES (1, 1, 'test', 'test');
INSERT INTO `hrms`.`user_role` (`USER_ID`,`roles_ID`) VALUES (1,1);
INSERT INTO `project` (`ID`, `DESCRIPTION`, `END_DATE`, `NAME`, `START_DATE`, `department_ID`) VALUES ('1', 'test project', '2018-02-01 00:00:00', 'WAA Project', '2017-11-09 00:00:00', NULL);
